      ...
      <div className="container-fluid px-4 py-3">
        ...
        <div className="row mb-4">
          <div className="col-12">
            <h4 className="fw-bold">Book Setup</h4>
          </div>
        </div>
        ...
        <div className="row g-4">
          ...
          <Link
            ...
            to="/Library/BookCategorySetup"
          >
            <div>
              <div className="card fee-setup-card h-100">
                <div className="card-body d-flex align-items-center justify-content-center">
                  <h5 className="card-title text-white m-0">Category Setup</h5>
                </div>
              </div>
            </div>
          </Link>
          ...
          <Link
            style={{ textDecoration: "none" }}
            className="col-12 col-md-6 col-lg-3"
            to="/Library/PublisherSetup"
          >
            <div>
              <div className="card fee-setup-card h-100">
                <div className="card-body d-flex align-items-center justify-content-center">
                  <h5 className="card-title text-white m-0">Publisher Setup</h5>
                </div>
              </div>
            </div>
          </Link>
          ...
          <Link
            style={{ textDecoration: "none" }}
            className="col-12 col-md-6 col-lg-3"
            to="/Library/AddNewBookDetail"
          >
            <div>
              <div className="card fee-setup-card h-100">
                <div className="card-body d-flex align-items-center justify-content-center">
                  <h5 className="card-title text-white m-0">Add New Book Details</h5>
                </div>
              </div>
            </div>
          </Link>
