...
export default function Bookissue_entry() {
      ...
      <div className="container-fluid px-4 py-3">
        ...
        <div className="row mb-4">
          <div className="col-12">
            <h4 className="fw-bold">Book Issue / Entry</h4>
          </div>
        </div>
        ...
        <div className="row g-4">
          ...
          <Link
            ...
            to="/Library/Book_issue"
          >
            <div>
              <div className="card fee-setup-card h-100">
                <div className="card-body d-flex align-items-center justify-content-center">
                  <h5 className="card-title text-white m-0">Book Issue</h5>
                </div>
              </div>
            </div>
          </Link>
          ...
          <Link
            style={{ textDecoration: "none" }}
            className="col-12 col-md-6 col-lg-3"
            to="/Library/Book_Return"
          >
            <div>
              <div className="card fee-setup-card h-100">
                <div className="card-body d-flex align-items-center justify-content-center">
                  <h5 className="card-title text-white m-0">Book Return</h5>
                </div>
              </div>
            </div>
          </Link>
